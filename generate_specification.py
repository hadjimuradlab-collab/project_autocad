...
SPEC_DATA = [
    ...
    ("9",  "Аккумуляторная батарея (ЗИП)",
            "АКБ 12В / 7А·ч",           "шт.", 1,
            "Запасная для Гранит-12 — плановая замена (через 3–5 лет)"),
    ("10", "Аккумуляторная батарея (ЗИП)",
            "АКБ 12В / 17А·ч",          "шт.", 1,
            "Запасная для РИП-12-3/17М — плановая замена (через 3–5 лет)"),
    ...
    ("15", "Коробка распределительная пожарная огнестойкая",
            "КРП IP54",                 "шт.", 12,
            "Установка над дверями в коридорах: 1 эт. — 7 (по числу шлейфов ИП и ИПР), 2 эт. — 5"),
    ("16", "Выносное устройство световой сигнализации",
            "УС-02",                    "шт.", 1,
            "Только для ИП серверной за подвесным потолком (СП 484 п. 6.6.13)"),
    ("17", "Узел уплотнения межэтажного кабельного прохода EI 60",
            "ПМБК (или ОГНЕТЕРМ)",      "шт.", 1,
            "Огнестойкость не менее EI 60 (СП 4.13130, СП 484 п. 6.7.4)"),
    ("18", "Устройство защиты от импульсных перенапряжений (УЗИП)",
            "УЗИП класс II, 220 В",     "шт.", 1,
            "На вводе 220 В питания ППКП и РИП-12"),
]
...
CALC_ROOMS = [
    ...
    (1, 1,  "Тамбур",                3.8,  1, 0, "СП 484 п. 6.6.5 — 1 ИП с резервированием извещателями шоурума №7 (ШС 3)"),
    ...
    (2, 10, "Кухня-столовая",       26.0,  0, 2, "Тепловые ИП 101-1А-А3 (преобладающий фактор — тепло от электроплит, СП 484 разд. 6.2 и прил. М)"),
