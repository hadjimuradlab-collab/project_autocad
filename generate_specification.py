...
CALC_ROOMS = [
    ...
    (1, 8,  "Архив",                20.0,  2, 0, "Логика «И»: 1 в ШС1, 1 в ШС2; ИП с УС-02"),
    (1, 9,  "Архив",                20.0,  2, 0, "Логика «И»: 1 в ШС1, 1 в ШС2; ИП с УС-02"),
    ...
    (2, 12, "Серверная",            14.5,  2, 0, "Логика «И»: 1 в ШС7, 1 в ШС8; ИП с УС-02"),
]
...
LOOPS_INFO = [
    ...
    (1,  "1 эт. сев. (осн.)", "Архив 8 (1 ИП-А), Архив 9 (1 ИП-А), Каб.10 (2), Бойлерная (2 ИП 101), Подсобное (2)", 8, 0.36),
    (2,  "1 эт. сев. (дубль для логики «И»)", "Архив 8 (1 ИП-Б), Архив 9 (1 ИП-Б)", 2, 0.09),
    ...
    (7,  "2 эт. центр+сев. (осн.)", "Ком.отд (2), Каб.дир (2), Кухня (2 ИП 101), Серверная (1 ИП-А), Коридор (3)", 10, 0.45),
    (8,  "2 эт. (дубль для логики «И»)", "Серверная (1 ИП-Б) + Коридор доп. (2)", 3, 0.14),
...
CABLE_LOG = [
    ...
    ("1", "ППКП — ШС 1 (1 эт. сев.)",
        "КПСВВнг(А)-LS 1×2×0,5", 85, "В МР-15", "8 устройств"),
    ("2", "ППКП — ШС 2 (1 эт. сев. дубль)",
        "КПСВВнг(А)-LS 1×2×0,5", 35, "В МР-15", "2 устройства, логика «И»"),
    ("3", "ППКП — ШС 3 (1 эт. юж.)",
    ...
    ("7", "ППКП — стояк — ШС 7 (2 эт. центр+сев.)",
        "КПСВВнг(А)-LS 1×2×0,5", 100, "В МР-15, стояк", "10 устройств"),
    ("8", "ППКП — стояк — ШС 8 (2 эт. дубль логики «И»)",
        "КПСВВнг(А)-LS 1×2×0,5", 30, "В МР-15", "3 устройства"),
